...
@section('content')
  <div id="values"
    data-changestatustoshipped="{{ route('status.shipped', $purchase->id) }}"
    ...
    <div class="detail">
      <dl>
        ...
        <div class="grid-container">
          ...
          <div class="grid-item">
            <dt class="detail-label">購入者名</dt>
            <dd class="detail-value">{{ $purchase->user->name }}</dd>
          </div>
          <div class="grid-item">
            <dt class="detail-label">購入者メールアドレス</dt>
            <dd class="detail-value">{{ $purchase->user->email }}</dd>
          </div>
          <div class="grid-item">
            <dt class="detail-label">購入者郵便番号</dt>
            <dd class="detail-value">〒 {{ $purchase->user->postal_code }}</dd>
          </div>
          <div class="grid-item">
            <dt class="detail-label">購入者住所</dt>
            <dd class="detail-value">{{ $purchase->user->address }}</dd>
          </div>
        </div>
      </dl>
    </div>
